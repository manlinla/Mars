//  restart a new list, clear the old table,create new table
...
public class MySQLTableCreation {
	...
	public static void main(String[] args) {
		try {
			...
			//create an instance "com.mysql.jdbc.driver" for the class. "reflection"
			//register driver "com.mysql.jdbc.driver"
			Class.forName("com.mysql.jdbc.Driver").newInstance();
			//getConnection: among all registered URL find the right one to create 
			//the connection with "com.mysql.jdbc.driver"
			...
			//step 2, drop table. delete the old tables, fresh start!
			Statement stmt = conn.createStatement();
			String sql = "DROP TABLE IF EXISTS history"; //sql statement by string
			stmt.executeUpdate(sql); // tell stmt to run sql (request it to mysql)
