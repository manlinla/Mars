...
public class TixMasterAPI {
	...
	// event includes:
	//  {
	//  "_embedded": its value is also a json object {
	//	    "venues": its key is a json object array [
	//	        {  each json is also a key value pair
	//		        "address": { //json object
	//		           "line1": "101 First St,", //value is a string
	//		           "line2": "Suite 101",
	//		           "line3": "...",
	//		        },
	//		        "city": {
	...
	// {"images": [{"url": "www.example.com/my_image.jpg"}, ...]} image link
	...
	public static void main(String[] args) {
		TixMasterAPI tmApi = new TixMasterAPI();
		// Mountain View, CA
